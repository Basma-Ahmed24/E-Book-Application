...
# Favourite Screen
# If the user like any book he can add it in this page 
...
# This Screen has book’s information and has two icon
# the first icon enablle user to add this book in favourate page 
# the second icon enable user to read the book
