...
import 'package:untitled/screens/computerscience.dart';
...
class Homescreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   return
   BlocConsumer<bookscubit,bookstates>(listener: (context,state){},
        ...
        //SizedBox(width: 10,),
          ...
          Padding(padding: EdgeInsets.all(0),
            child: Column(mainAxisAlignment: MainAxisAlignment.start,
                ...
                children: [
                  SizedBox(height: 20),
                  Row(children: [  IconButton(icon:Icon(Icons.west, color: Colors.black26, size: 35),onPressed: (){
                    navigateto(context,Welcomepage());}),
              SizedBox(width: 235,),IconButton(icon:Icon(Icons.search,color: Colors.black26, size: 35),onPressed: (){
                    navigateto(context,Search());}),
                    SizedBox(width: 10),
                    IconButton(onPressed: (){},
                     icon:Icon( Icons.brightness_4_outlined, color: Colors.black26, size: 35,))
                  ],),
                  ...
                  Row(children: [
SizedBox(width: 3,),
                   Expanded(child: TextButton(onPressed: () {bookscubit.get(context).buss();
                     navigateto(context, Businuss());}, child: Text(
                        "Business", style: Theme.of(context).textTheme.bodyText2)
                    ))
                    ,SizedBox(width: 4,),Expanded(child:
                    TextButton( onPressed: () {navigateto(context, Computer());}, child: Text(
                      "Computer Science", style: Theme.of(context).textTheme.bodyText2)

                    ),),


                      Expanded(
                        child: TextButton(onPressed: () {navigateto(context, Math());}, child: Text(
                        "Math & Science", style: Theme.of(context).textTheme.bodyText2)
                   ...
                   SizedBox(width:0,),
                    Expanded(
                      child: TextButton(onPressed: () {navigateto(context, History());}, child: Text(
                        "History", style:Theme.of(context).textTheme.bodyText2
                 ...
                 ,SizedBox(width: 12,height: 10,) ],),
                  Row(children: [
                    SizedBox(width: 7,height: 0,),
                    Text("Recently Added", style: Theme.of(context).textTheme.bodyText2),
                  ],),
                 ...
                 Expanded(flex:1,
                   child: ConditionalBuilder(condition:state is ! loadingstate ,
