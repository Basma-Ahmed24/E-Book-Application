          ...
          return Scaffold( body: Column(mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(height: 20,width: 10,),Row(
                  children:[ IconButton(icon:Icon(Icons.west,color: Colors.black26, size: 35),onPressed: (){
                    navigateto(context,MyNavigationBar());}), SizedBox(width: 40,),Text("Computer Science", style: GoogleFonts.poppins(
                      fontSize: 23, fontWeight: FontWeight.w600, color: Color
                      .fromRGBO(19, 10, 105, 0.7)),), SizedBox(width: 38,),IconButton(icon:Icon(Icons.search,color: Colors.black26, size: 35),onPressed: (){bookscubit.get(context).comp();
                  }),
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage("assets/fa691691526776c99476dc53a2b3d486.png"),
                        fit: BoxFit.cover,)
                  )
